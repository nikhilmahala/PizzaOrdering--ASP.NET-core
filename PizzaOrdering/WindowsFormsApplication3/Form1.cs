    ...
    public partial class Form1 : Form
    {
        ...
        private void button8_Click(object sender, EventArgs e)
        {
           ...
           if (dialog == DialogResult.Yes)
           {
                ...
                PizzaDBEntities4 obj = new PizzaDBEntities4();
                orddetail ord = new orddetail();

                ord.fname = textBox11.Text;
                ord.lname = textBox12.Text;
                ord.address = textBox13.Text;
                ord.state = comboBox1.Text;
                ord.city = textBox14.Text;
                ord.postalcode = textBox15.Text;
                ord.phnno = textBox16.Text;
                ord.email = textBox17.Text;

                obj.orddetails.Add(ord);
                obj.SaveChanges();

                payment pay = new payment();

                pay.paymethod = comboBox2.Text;
                pay.cardno = textBox18.Text;
                pay.amount = textBox10.Text;


                obj.payments.Add(pay);
                obj.SaveChanges();
               ...
               comboBox2.Text = "";
                ...
                int num = 1;
                var val = obj.orddetails.FirstOrDefault(u => u.ordno == num);
